...
export default function Navbar({ soundEnabled, setSoundEnabled, playUiClick }) {
  ...
  return (
    <motion.nav
      ...
      className="w-full border-b-3 border-white bg-[#000000] sticky top-0 z-40 px-4 md:px-8 py-3 shadow-[0px_4px_0px_0px_var(--color-primary,#39FF14)]"
    >
      <div className="max-w-3xl mx-auto flex items-center justify-between font-mono">
        ...
        >
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
            className="hover:shadow-[6px_6px_0px_0px_var(--color-primary,#39FF14)] transition-all"
          >
            <BrandLogo size="md" />
          </motion.div>
          <span className="text-xl font-black tracking-tight text-white group-hover:text-[var(--color-primary,#39FF14)] transition-colors">
            aditya<span className="text-[var(--color-primary,#39FF14)]">here.</span>
          </span>
        </NavLink>
                ...
                <NavLink to={item.path} onClick={handleNavClick}>
                  <motion.div
                    ...
                    className={`px-3 py-1.5 text-xs font-bold font-mono border-2 border-white flex items-center gap-1.5 transition-all ${
                      isActive
                        ? 'bg-[var(--color-primary,#39FF14)] text-black shadow-[6px_6px_0px_0px_#ffffff]'
                        : 'bg-[#000000] text-white hover:bg-neutral-900 shadow-[2px_2px_0px_0px_var(--color-primary,#39FF14)] hover:shadow-[6px_6px_0px_0px_var(--color-primary,#39FF14)]'
                    }`}
                  >
                    {item.icon}
          ...
          <motion.div variants={itemVariants}>
            <motion.button
              ...
              className={`p-1.5 border-2 border-white font-bold transition-all ml-1 ${
                soundEnabled
                  ? 'bg-[var(--color-primary,#39FF14)] text-black shadow-[6px_6px_0px_0px_var(--color-primary,#39FF14)]'
                  : 'bg-[#181818] text-neutral-400 shadow-[2px_2px_0px_0px_#444] hover:shadow-[6px_6px_0px_0px_var(--color-primary,#39FF14)]'
              }`}
