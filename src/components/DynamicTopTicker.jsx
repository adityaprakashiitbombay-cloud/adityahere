...
import { Radio, X, Sparkles, Award, Zap, Cpu, BookOpen, Heart, Flame, MessageSquare, Rocket, Trophy, Sigma, Atom, GraduationCap } from 'lucide-react';
...
export default function DynamicTopTicker({ playUiClick }) {
  ...
  const currentAlert = ANNOUNCEMENTS[badgeIdx] || ANNOUNCEMENTS[0];
